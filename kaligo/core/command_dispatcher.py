...
class CommandDispatcher(KaligoBase):
    ...
    def unregister_command(self: "Kaligo", cmd: command.Command) -> None:
    ...
    def register_commands(self: "Kaligo", mod: module.Module) -> None:
    ...
    def unregister_commands(self: "Kaligo", mod: module.Module) -> None:
        to_unreg = []
    ...
    def command_predicate(self: "Kaligo") -> Filter:
    ...
    async def on_command(self: "Kaligo", _: Client, message: Message) -> None:
