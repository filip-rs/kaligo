...
from kaligo.conversation import Conversation, ConversationExistError
...
class ConversationDispatcher(KaligoBase):
    ...
    def conversation_predicate(self: "KaligoBase") -> Filter:
    ...
    async def on_conversation(
        self: "Kaligo", client: Client, msg: Message  # skipcq: PYL-W0613
    ) -> None:
