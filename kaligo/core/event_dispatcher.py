...
from kaligo import module, util
from kaligo.listener import Listener, ListenerFunc
...
class EventDispatcher(KaligoBase):
    ...
    def unregister_listener(self: "Kaligo", listener: Listener) -> None:
    ...
    def register_listeners(self: "Kaligo", mod: module.Module) -> None:
    ...
    def unregister_listeners(self: "Kaligo", mod: module.Module) -> None:
        to_unreg = []
    ...
    async def dispatch_event(
        self: "Kaligo", event: str, *args: Any, wait: bool = True, **kwargs: Any
    ) -> None:
        tasks = set()
    ...
    async def log_stat(self: "Kaligo", stat: str) -> None:
