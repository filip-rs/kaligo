...
from kaligo import custom_modules, module, modules, util
...
class ModuleExtender(KaligoBase):
    ...
    def load_module(
        self: "Kaligo", cls: Type[module.Module], *, comment: Optional[str] = None
    ) -> None:
    ...
    def unload_module(self: "Kaligo", mod: module.Module) -> None:
        cls = type(mod)
    ...
    def load_all_modules(self: "Kaligo") -> None:
    ...
    def unload_all_modules(self: "Kaligo") -> None:
    ...
    async def reload_module_pkg(self: "Kaligo") -> None:
